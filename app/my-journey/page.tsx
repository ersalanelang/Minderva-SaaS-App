    ...
    <main className="container mx-auto w-full md:w-3/4 max-w-6xl px-4">
      <section className="flex justify-between gap-4 max-md:flex-col items-center">
        ...
        <div className="flex gap-4">
          <div className="border borde-black rounded-lg p-3 gap-2 flex flex-col h-fit">
      ...
      <Accordion type="multiple">
        ...
        <AccordionItem value="companions">
          <AccordionTrigger className="text-2xl font-bold cursor-pointer">My Companions {`(${companions.length})`}</AccordionTrigger>
          <AccordionContent>
